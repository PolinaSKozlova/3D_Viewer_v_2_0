...
class MainWindow : public QMainWindow {
 ...
 private:
  ...
  void setState(std::string& basePath, ui_state_t& uiState);
  void setDefaults(std::string& basePath);
  void loadConf(std::string& confPath, ui_state_t& uiState);
  void saveConf(std::string& basePath, ui_state_t& uiState);
